...
public interface UserProfileDao {
	...
	String GET_MAX_USER_PROFILE_ID = "SELECT max(Profile_ID) FROM test.USER_PROFILE_TBL";
	...
	@Select(GET_MAX_USER_PROFILE_ID)
	@Options(useCache = false)
	public int selectMaxUserProfileID() throws Exception;
